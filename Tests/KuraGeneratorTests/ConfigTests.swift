...
struct ConfigTests {
    ...
    private func writeYaml(_ content: String, filename: String = UUID().uuidString + ".yml") throws -> String {
    ...
    @Test func appliesDefaultsWhenOptionalFieldsAreMissing() throws {
        ...
        #expect(config.swiftDeclaration == "internal")
    ...
    @Test func loadDefaultFallsBackToArkanaYml() throws {
        ...
        let config = try KuraConfig.loadDefault()
